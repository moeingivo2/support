...
import type { SessionSourcesPagination } from '../services/resourceService'

type SessionSourcePaginationProps = {
  pagination: SessionSourcesPagination
  onPageChange: (page: number) => void
}

export function SessionSourcePagination({
  pagination,
  onPageChange,
}: SessionSourcePaginationProps) {
