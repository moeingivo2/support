...
import type { ShiftReportsPagination } from '../services/shiftReportService'

type ShiftReportPaginationProps = {
  pagination: ShiftReportsPagination
  onPageChange: (page: number) => void
}

export function ShiftReportPagination({ pagination, onPageChange }: ShiftReportPaginationProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-4 rounded-4xl border border-border/10 bg-deactive-btn-gray/70 p-4 md:flex-row">
      <p className="text-xs text-zinc-500">
        ...
        {pagination.total.toLocaleString('fa-IR')} گزارش
      </p>
